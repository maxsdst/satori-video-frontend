...
import { setFollowingVideos } from "../mocks/db";
import {
    createVideos,
    navigateTo,
    simulateScrollToEnd,
...
describe("FollowingPage", () => {
    ...
    describe("video grid", () => {
        it("should render video grid with videos from following profiles", async () => {
        ...
        it("should redirect to the video page with videos from following profiles when an item is clicked", async () => {
            createVideos(3, {}); // other videos
            const videos = createVideos(3, {});
            setFollowingVideos(videos);
            const {
...
function navigateToPage() {
    const { getLocation } = navigateTo("/following");
